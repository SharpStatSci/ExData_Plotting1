...
# Recreate plot 2: A plot of Active power in kw by minute

plot2 <- function() {
    plot(power.df$Global_active_power~power.df$Date.Time, type="l", xlab=" ", ylab="Global Active Power (kilowatts)")
